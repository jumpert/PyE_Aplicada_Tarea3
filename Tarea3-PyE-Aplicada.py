...
for tipo in tipos:
    ...
    tabla.add_row([muestra, round(median,2), mode])
print(tabla)
tabla.clear_rows()
...
for tipo in tipos:
    ...
    media_teorica = n*p
    tabla.add_row([muestra, round(media_empirica,2), media_teorica])
print(tabla)
tabla.clear_rows()
...
for tipo in tipos:
    ...
    tabla.add_row([muestra, round(varianza_empirica,2), varianza_teorica])
print(tabla)
tabla.clear_rows()
